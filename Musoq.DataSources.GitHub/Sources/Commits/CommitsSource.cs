...
internal class CommitsSource : AsyncRowsSourceBase<CommitEntity>
{
    ...
    public CommitsSource(IGitHubApi api, RuntimeContext runtimeContext, string owner, string repo,
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            else if (!string.IsNullOrEmpty(parameters.Sha)) request.Sha = parameters.Sha;

            if (!string.IsNullOrEmpty(parameters.Path)) request.Path = parameters.Path;

            if (!string.IsNullOrEmpty(parameters.Author)) request.Author = parameters.Author;
