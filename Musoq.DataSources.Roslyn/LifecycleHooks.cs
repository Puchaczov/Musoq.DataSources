...
#pragma warning restore CA2255
    ...
    public static async Task<(int ReturnValue, Exception[] Exceptions)> LoadToMemoryAsync(string[] args,
    ...
    public static async Task<(int ReturnValue, Exception[] Exceptions)> SetAsync(string[] args,
        CancellationToken cancellationToken)
    {
        try
        {
    ...
    /// <returns>0 if succeeded, otherwise error code</returns>
    /// <exception cref="NullReferenceException">Thrown when the logger is null.</exception>
    public static async Task<(int ReturnValue, Exception[] Exceptions, string? Value)> GetAsync(string[] args,
        CancellationToken cancellationToken)
    {
    ...
    /// <param name="cancellationToken">Cancellation token.</param>
    /// <returns>0 if succeeded, otherwise error code</returns>
    public static async Task<(int ReturnValue, Exception[] Exceptions)> UnloadFromMemoryAsync(string[] args,
        CancellationToken cancellationToken)
    {
        try
        {
