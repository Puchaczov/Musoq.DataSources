...
public class PatchEntity(Patch patch, Repository repository)
{
    /// <summary>
    ...
    public IEnumerable<PatchEntryChangesEntity> Changes => patch.Select(change => new PatchEntryChangesEntity(change, repository));
}