...
public class GitHubBranchesTests
{
    ...
    public void WhenBranchesQueried_ShouldReturnValues()
    {
        ...
        api.Setup(f => f.GetBranchesAsync("testowner", "testrepo", It.IsAny<int?>(), It.IsAny<int?>()))
            ...
            {
                MockEntityFactory.CreateBranch("main", "abc123", true, "testowner", "testrepo"),
                MockEntityFactory.CreateBranch("develop", "def456", false, "testowner", "testrepo"),
                MockEntityFactory.CreateBranch("feature-branch", "ghi789", false, "testowner", "testrepo")
            });
    ...
    public void WhenBranchesFilteredByProtected_ShouldReturnProtectedOnly()
    {
        ...
        api.Setup(f => f.GetBranchesAsync("testowner", "testrepo", It.IsAny<int?>(), It.IsAny<int?>()))
            ...
            {
                MockEntityFactory.CreateBranch("main", "abc123", true, "testowner", "testrepo"),
                MockEntityFactory.CreateBranch("develop", "def456", true, "testowner", "testrepo"),
