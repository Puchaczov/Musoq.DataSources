...
public class GitHubReleasesTests
{
    ...
    public void WhenReleasesQueried_ShouldReturnValues()
    {
        ...
        api.Setup(f => f.GetReleasesAsync("testowner", "testrepo", It.IsAny<int?>(), It.IsAny<int?>()))
            ...
            {
                MockEntityFactory.CreateRelease(id: 1, tagName: "v1.0.0", name: "Version 1.0.0", prerelease: false, draft: false),
                MockEntityFactory.CreateRelease(id: 2, tagName: "v2.0.0-beta", name: "Version 2.0.0 Beta", prerelease: true, draft: false),
                MockEntityFactory.CreateRelease(id: 3, tagName: "v2.0.0", name: "Version 2.0.0", prerelease: false, draft: false)
            });
        ...
        // Order is not guaranteed, so check that releases exist by tag
        ...
        Assert.AreEqual(true, v2BetaRelease[4]); // Prerelease
    ...
    public void WhenReleasesFilteredByDraft_ShouldExcludeDrafts()
    {
        ...
        api.Setup(f => f.GetReleasesAsync("testowner", "testrepo", It.IsAny<int?>(), It.IsAny<int?>()))
            ...
            {
                MockEntityFactory.CreateRelease(id: 1, tagName: "v1.0.0", name: "Version 1.0.0", prerelease: false, draft: false),
                MockEntityFactory.CreateRelease(id: 2, tagName: "v2.0.0-draft", name: "Draft Release", prerelease: false, draft: true)
            });
