...
public class PostgresQueryTests
{
    ...
    public void WhenOnlyFilteredRowsSelected_ShouldReturnSingle()
    {
        ...
        var vm = CreateAndRunVirtualMachineWithResponse(script, new PostgresTestTable
        {
            Key = "1",
            Value = 1,
            Id = Guid.Empty
    ...
    private static CompiledQuery CreateAndRunVirtualMachineWithResponse<TEntity>(string script,
