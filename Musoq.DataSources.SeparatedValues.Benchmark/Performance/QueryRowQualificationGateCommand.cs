...
internal static class QueryRowQualificationGateCommand
{
    public static int Run(string[] args, TextWriter output, TextWriter error)
    {
        ...
        catch (Exception exception) when (exception is ArgumentException or InvalidDataException or IOException or JsonException)
        {
    ...
    private static QueryRowQualificationInputs Parse(IReadOnlyList<string> args)
    {
        ...
        var coreSourceReports = new List<string>();
        ...
        for (var index = 0; index < args.Count; index++)
        {
            ...
            switch (option)
            {
                ...
                case "--compiled-report":
                    ...
                    break;
                case "--core-source-report":
                    coreSourceReports.Add(value);
                    break;
                case "--disassembly":
                    if (disassembly != null)
    ...
    private const string Usage =
        ...
        "--compiled-report <report> (at least x3) --core-source-report <report> (at least x3) " +
        "--disassembly <jit-disassembly.txt>";
}
