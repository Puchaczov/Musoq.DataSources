...
internal class EventsSourceHelper
{
    ...
    [
        ...
        new SchemaColumn(nameof(EventEntity.EventTime), 3, typeof(DateTime?)),
        new SchemaColumn(nameof(EventEntity.FirstTimestamp), 4, typeof(DateTime?)),
        ...
        new SchemaColumn(nameof(EventEntity.LastTimestamp), 7, typeof(DateTime?)),
