...
internal static class ConfigmapsSourceHelper
{
    ...
    internal static readonly IReadOnlyDictionary<int, Func<ConfigmapEntity, object?>> ConfigmapsIndexToMethodAccessMap =
        new Dictionary<int, Func<ConfigmapEntity, object?>>
        {
            { 0, t => t.Namespace },
            { 1, t => t.Name },
            { 2, t => t.Age }
