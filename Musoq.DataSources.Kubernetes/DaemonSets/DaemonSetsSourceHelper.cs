...
internal static class DaemonSetsSourceHelper
{
    ...
    internal static readonly IReadOnlyDictionary<int, Func<DaemonSetEntity, object?>> DaemonSetsIndexToMethodAccessMap =
        new Dictionary<int, Func<DaemonSetEntity, object?>>
        {
            { 0, c => c.Namespace },
            { 1, c => c.Name },
            { 2, c => c.Desired },
