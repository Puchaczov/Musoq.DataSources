...
public class NugetResolveRawTests
{
    ...
    public async Task SolutionPlayground()
    {
        ...
        var solutionEntity = await CreateSolutionAsync(solutionFilePath, httpClient, fileSystem, null, new NuGetPropertiesResolver("https://localhost:7137", httpClient), NullLogger.Instance, CancellationToken.None);
