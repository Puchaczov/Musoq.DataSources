        ...
        RunWithNugetPackages(() =>
        {
            ...
            var expectedPackages = new[]
            {
                ...
                new NugetPackageExpectation
                {
                    ...
                    Version = "17.8.0",
                    LicenseUrl = "https://www.nuget.org/packages/Microsoft.NET.Test.Sdk/17.8.0/License",
                ...
                new NugetPackageExpectation
                {
                    ...
                    Id = "NUnit",
                    Version = "3.14.0",
                    LicenseUrl = "https://www.nuget.org/packages/NUnit/3.14.0/License",
                ...
                new NugetPackageExpectation
                {
                    ...
                    Id = "NUnit.Analyzers",
                    Version = "3.9.0",
                    LicenseUrl = "https://www.nuget.org/packages/NUnit.Analyzers/3.9.0/License",
